...
PrefilterPass::PrefilterPass(): TemplatePass() {}

PrefilterPass::~PrefilterPass() {}

bool PrefilterPass::render(const glm::mat4 &p, const glm::mat4 &v, const glm::mat4 &m) {
//    return TemplatePass::render(p, v, m);
    return true;
}

void PrefilterPass::render(const glm::mat4 &p, const glm::mat4 &v) {

}

void PrefilterPass::initShader() {
    std::vector<char> vertexShaderCode = readFileFromAssets("shaders/prefilter.vert");
    vertexShaderCode.push_back('\0');
    std::vector<char> fragmentShaderCode = readFileFromAssets("shaders/prefilter.frag");
    ...
    for (unsigned int mip = 0; mip < maxMipLevels; ++mip)
    {
        ...
        mShader.setUniformFloat("roughness", roughness);
        for (unsigned int i = 0; i < 6; ++i)
        {
...
void PrefilterPass::draw() {

}
// renderCube() renders a 1x1 3D cube in NDC.
// -------------------------------------------------

void PrefilterPass::renderCube()
{
