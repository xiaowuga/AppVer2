...
IrradiancePass::IrradiancePass(): TemplatePass() {}

IrradiancePass::~IrradiancePass() {}

bool IrradiancePass::render(const glm::mat4 &p, const glm::mat4 &v, const glm::mat4 &m) {
//    return TemplatePass::render(p, v, m);
    return true;
}

void IrradiancePass::render(const glm::mat4 &p, const glm::mat4 &v) {

}

void IrradiancePass::initShader() {
    std::vector<char> vertexShaderCode = readFileFromAssets("shaders/irradiance.vert");
    vertexShaderCode.push_back('\0');
    std::vector<char> fragmentShaderCode = readFileFromAssets("shaders/irradiance.frag");
...
void IrradiancePass::draw() {
}
// renderCube() renders a 1x1 3D cube in NDC.
// -------------------------------------------------

void IrradiancePass::renderCube()
{
