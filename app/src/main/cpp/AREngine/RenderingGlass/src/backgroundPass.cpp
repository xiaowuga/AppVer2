...
BackgroundPass::BackgroundPass(): TemplatePass() {}

BackgroundPass::~BackgroundPass() {}

bool BackgroundPass::render(const glm::mat4 &p, const glm::mat4 &v, const glm::mat4 &m) {
    render(p,v);
    return true;
}

void BackgroundPass::render(const glm::mat4 &p, const glm::mat4 &v) {
#if 1
...
//    brdfPass->getShader().use();
//    brdfPass->renderQuad();
#endif
}

void BackgroundPass::initShader() {
    std::vector<char> vertexShaderCode = readFileFromAssets("shaders/background.vert");
    vertexShaderCode.push_back('\0');
    std::vector<char> fragmentShaderCode = readFileFromAssets("shaders/background.frag");
...
void BackgroundPass::draw() {
}
// renderCube() renders a 1x1 3D cube in NDC.
// -------------------------------------------------

void BackgroundPass::renderCube()
{
