...
Object3D::Object3D(const string objFilename, const cv::Matx44f pose, float scale, float qualityThreshold,  vector<float> &templateDistances) : Model(objFilename, pose, scale)
{
