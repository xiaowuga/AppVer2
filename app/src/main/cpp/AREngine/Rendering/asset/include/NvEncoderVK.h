...
class NvEncoderVK : public NvEncoder
{
public:
    NvEncoderVK(CUcontext cuContext, uint32_t nWidth, uint32_t nHeight, NV_ENC_BUFFER_FORMAT eBufferFormat,
    ...
    int32_t GetNumInputBuffers(){return m_numInputBuffers;}
