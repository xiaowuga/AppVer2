...
typedef struct XrRokidMarkerExt {
    const char*    name;
    float          pose[7];
    float          size[2];
    uint32_t       imageIndex;
...
typedef struct XrRokidMarkerArrayExt {
    XrRokidMarkerExt**    elements;
    uint32_t              size;
} XrRokidMarkerArrayExt;

typedef struct XrRokidMarkerIdArrayExt {
    intptr_t*    elements;
    uint32_t     size;
} XrRokidMarkerIdArrayExt;

typedef struct XrRokidMarker2ArrayExt {
    intptr_t*    elements;
    uint32_t     size;
} XrRokidMarker2ArrayExt;

typedef struct XrRokidAnchorExt {
    intptr_t    id;
    float       pose[7];
    uint32_t    score;
    uint32_t    flags;
...
typedef struct XrRokidAnchorArrayExt {
    XrRokidAnchorExt**    elements;
    uint32_t              size;
} XrRokidAnchorArrayExt;

typedef struct XrRokidAnchorIdArrayExt {
    intptr_t*    elements;
    uint32_t     size;
} XrRokidAnchorIdArrayExt;

typedef struct XrRokidAnchorMapExt {
    char    uuid[37];
} XrRokidAnchorMapExt;

typedef struct XrRokidAnchorMapArrayExt {
    XrRokidAnchorMapExt*    elements;
    uint32_t                size;
} XrRokidAnchorMapArrayExt;
...
typedef void (*PFN_xrGlassPSensorListener) (int32_t flag, void* arg);
typedef void (*PFN_xrGlassStatusListener) (uint32_t flag, void* arg);
typedef void (*PFN_xrCameraPreviewListener)(const uint8_t* data, uint32_t size, uint16_t width, uint16_t height, int64_t timestamp, void* arg);
typedef void (*PFN_xrSensorListener)(const float* acc, const float* gyr, const float* mag, int64_t timestamp, void* arg);
typedef void (*PFN_xrRotationListener)(const float* gameRotation, const float* rotation, int64_t timestamp, void* arg);
typedef void (*PFN_xrGlassBrightListener) (uint32_t flag, void* arg);
...
typedef XrResult (XRAPI_PTR *PFN_xrGetOriPhonePose)(float* out);
...
typedef XrResult (XRAPI_PTR *PFN_xrGetHistoryPose)(uint64_t timeStamp, float* position, float* orientation);
...
typedef XrResult (XRAPI_PTR *PFN_xrGetFrustumInfo)(float* frustum_left, float* frustum_right);
typedef XrResult (XRAPI_PTR *PFN_xrGetSLAMQuality)(uint32_t* trackingStatus, uint32_t* imageQuality, uint32_t* kineticQuality);
typedef XrResult (XRAPI_PTR *PFN_xrGetCurrentFrameTimeStamp)(uint64_t* timeStamp);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassName)(char* glass_name, int32_t outSize);
typedef XrResult (XRAPI_PTR *PFN_xrIsUsbConnect)(XrBool32* isUsbConnect);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassProductId)(int32_t* product_id);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassTypeId)(char* glass_typeid, int32_t outSize);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassSeed)(char* glass_seed, int32_t outSize);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassSn)(char* glass_sn, int32_t outSize);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassFirmwareVersion)(char* firmware_version, int32_t outSize);
...
typedef XrResult (XRAPI_PTR *PFN_xrRKOpenMarker)(const void* database, uint32_t size);
typedef XrResult (XRAPI_PTR *PFN_xrRKCloseMarker)(void);
typedef XrResult (XRAPI_PTR *PFN_xrRKMarkerAcquireChanges)(XrRokidMarkerArrayExt* added, XrRokidMarkerArrayExt* updated, XrRokidMarkerIdArrayExt* removed, intptr_t* handle);
typedef XrResult (XRAPI_PTR *PFN_xrRKMarkerReleaseChanges)(intptr_t handle);
typedef XrResult (XRAPI_PTR *PFN_xrRKMarkerAddImagePhy)(const char* name, int32_t id, const uint8_t* imageData, int32_t widthInPixel, int32_t heightInPixel, int32_t stride, float widthInMeter, float heightInMeter);
typedef XrResult (XRAPI_PTR *PFN_xrRKOpenMarker2)(const void* database, uint32_t size);
typedef XrResult (XRAPI_PTR *PFN_xrRKCloseMarker2)(void);
typedef XrResult (XRAPI_PTR *PFN_xrRKMarker2AddImagePhy)(const char* id, const uint8_t* imageData, int32_t width, int32_t height, int32_t stride, float widthInMeter, float heightInMeter);
typedef XrResult (XRAPI_PTR *PFN_xrRKMarker2AcquireChanges)(XrRokidMarker2ArrayExt* added, XrRokidMarker2ArrayExt* updated, XrRokidMarker2ArrayExt* removed);
typedef XrResult (XRAPI_PTR *PFN_xrRKMarker2GetCenterPose)(intptr_t marker, float* out);
typedef XrResult (XRAPI_PTR *PFN_xrRKMarker2GetExtent)(intptr_t marker, float* outX, float* outZ);
typedef XrResult (XRAPI_PTR *PFN_xrRKMarker2GetId)(intptr_t marker, char* id, int idSize);
typedef XrResult (XRAPI_PTR *PFN_xrRKMarker2GetAlgoId)(intptr_t marker, intptr_t* id);
typedef XrResult (XRAPI_PTR *PFN_xrRKOpenAnchor)(const void* arg, uint32_t size);
typedef XrResult (XRAPI_PTR *PFN_xrRKCloseAnchor)(void);
typedef XrResult (XRAPI_PTR *PFN_xrRKAnchorAcquireChanges)(XrRokidAnchorArrayExt* added, XrRokidAnchorArrayExt* updated, XrRokidAnchorIdArrayExt* removed, int32_t* err, intptr_t* handle);
typedef XrResult (XRAPI_PTR *PFN_xrRKAnchorReleaseChanges)(intptr_t handle);
typedef XrResult (XRAPI_PTR *PFN_xrRKAnchorTryAdd)(const float* pose, XrRokidAnchorExt* out);
typedef XrResult (XRAPI_PTR *PFN_xrRKAnchorTryRemove)(intptr_t id);
typedef XrResult (XRAPI_PTR *PFN_xrRKAnchorSave)(intptr_t id);
typedef XrResult (XRAPI_PTR *PFN_xrRKMapGetAll)(XrRokidAnchorMapArrayExt* out);
typedef XrResult (XRAPI_PTR *PFN_xrRKMapRemove)(const XrRokidAnchorMapExt* map);
typedef XrResult (XRAPI_PTR *PFN_xrRKMapGetAnchors)(const XrRokidAnchorMapExt* map, XrRokidAnchorIdArrayExt* out);
typedef XrResult (XRAPI_PTR *PFN_xrOpenGestureTracker)(void);
typedef XrResult (XRAPI_PTR *PFN_xrCloseGestureTracker)(void);
typedef XrResult (XRAPI_PTR *PFN_xrGetTrackingHandNum)(uint32_t* number);
typedef XrResult (XRAPI_PTR *PFN_xrGetTrackingHandLrHand)(uint32_t index, uint32_t* hand);
typedef XrResult (XRAPI_PTR *PFN_xrGetTrackingHandCombineGestureType)(uint32_t index, uint32_t* type);
typedef XrResult (XRAPI_PTR *PFN_xrGetTrackingHandOrientation)(uint32_t index, uint32_t* orientation);
typedef XrResult (XRAPI_PTR *PFN_xrGetUpForwardInfluencePow)(float* factor);
typedef XrResult (XRAPI_PTR *PFN_xrGetTrackingHandPinchDistance)(uint32_t index, float* distance);
typedef XrResult (XRAPI_PTR *PFN_xrGetGestureSkeletonPosition)(float* data, uint32_t index, uint32_t mode);
typedef XrResult (XRAPI_PTR *PFN_xrGetGestureSkeletonRotation)(float* data, uint32_t index, uint32_t mode, uint32_t type);
typedef XrResult (XRAPI_PTR *PFN_xrRecenterHeadTrackerY)(void);
typedef XrResult (XRAPI_PTR *PFN_xrSetTrackingType)(int32_t type);
typedef XrResult (XRAPI_PTR *PFN_xrSetGlassPSensorListener)(PFN_xrGlassPSensorListener listener);
typedef XrResult (XRAPI_PTR *PFN_xrClearGlassPSensorListener)(void);
typedef XrResult (XRAPI_PTR *PFN_xrSetPropertiesValue)(char* key, char* value);
typedef XrResult (XRAPI_PTR *PFN_xrGetPropertiesValue)(char* key, char* value);
typedef XrResult (XRAPI_PTR *PFN_xrResetSlam)(void);
typedef XrResult (XRAPI_PTR *PFN_xrVibrate)(int32_t effectId);
typedef XrResult (XRAPI_PTR *PFN_xrGetMainScreenWidth)(int32_t* width);
typedef XrResult (XRAPI_PTR *PFN_xrGetMainScreenHeight)(int32_t* height);
typedef XrResult (XRAPI_PTR *PFN_xrGetDebugInfo)(char* debugInfo, int32_t size);
typedef XrResult (XRAPI_PTR *PFN_xrConfigSlam)(int32_t type, int32_t value);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraYPR)(float* ypr);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassScreenWidth)(int32_t* width);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassScreenHeight)(int32_t* height);
typedef XrResult (XRAPI_PTR *PFN_xrSetGlassStatusListener)(PFN_xrGlassStatusListener listener);
typedef XrResult (XRAPI_PTR *PFN_xrSetGestureLogLevel)(const char* lv);
typedef XrResult (XRAPI_PTR *PFN_xrStartCameraPreview)(void);
typedef XrResult (XRAPI_PTR *PFN_xrStopCameraPreview)(void);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraStatus)(int32_t* flag);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraPreviewDimension)(uint16_t* width, uint16_t* height);
typedef XrResult (XRAPI_PTR *PFN_xrSetCameraPreviewListener)(PFN_xrCameraPreviewListener listener);
typedef XrResult (XRAPI_PTR *PFN_xrNotifyHandTrackerRecenter)(void);
typedef XrResult (XRAPI_PTR *PFN_xrSetGlassIMUListener)(PFN_xrSensorListener sensorListenerP, PFN_xrRotationListener rotationListenerP);
typedef XrResult (XRAPI_PTR *PFN_xrClearGlassIMUListener)(void);
typedef XrResult (XRAPI_PTR *PFN_xrOpenHeadTracker)(void);
typedef XrResult (XRAPI_PTR *PFN_xrCloseHeadTracker)(void);
typedef XrResult (XRAPI_PTR *PFN_xrOpenPhoneTracker)(void);
typedef XrResult (XRAPI_PTR *PFN_xrClosePhoneTracker)(void);
typedef XrResult (XRAPI_PTR *PFN_xrSetGlassBrightListener)(PFN_xrGlassBrightListener listener);
typedef XrResult (XRAPI_PTR *PFN_xrClearGlassBrightListener)(void);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassBrightness)(int32_t* value);
typedef XrResult (XRAPI_PTR *PFN_xrSetGlassBrightness)(int32_t value);
typedef XrResult (XRAPI_PTR *PFN_xrGetGlassCalFile)(uint8_t* value, uint32_t bufSize);
typedef XrResult (XRAPI_PTR *PFN_xrSetGestureUseDSP)(int32_t value);
typedef XrResult (XRAPI_PTR *PFN_xrSetGestureUseFishEyeDistort)(int32_t value);
typedef XrResult (XRAPI_PTR *PFN_xrGetSkeletonRotationAll)(float* data, int32_t index, int32_t type);
typedef XrResult (XRAPI_PTR *PFN_xrGetSkeletonCAM_GLAxis)(float* data, int32_t index);
typedef XrResult (XRAPI_PTR *PFN_xrGetHeadPoseRHS)(float* position, float* orientation, int64_t* timestamp);
typedef XrResult (XRAPI_PTR *PFN_xrGetMagnCalibSteps)(uint32_t* steps);
typedef XrResult (XRAPI_PTR *PFN_xrStartMagnCalib)(uint32_t step);
typedef XrResult (XRAPI_PTR *PFN_xrStopMagnCalib)(void);
typedef XrResult (XRAPI_PTR *PFN_xrResetMagnCalib)(void);
typedef XrResult (XRAPI_PTR *PFN_xrGetMagnCalibStatus)(uint32_t step, int32_t* status);
typedef XrResult (XRAPI_PTR *PFN_xrResetHead3DofCenter)(void);
typedef XrResult (XRAPI_PTR *PFN_xrGetDistortionQuad)(float* quad_left, float* quad_right);
typedef XrResult (XRAPI_PTR *PFN_xrHeadTrackingFix)(int32_t ypr);
typedef XrResult (XRAPI_PTR *PFN_xrSet3DofAlpha)(float alpha);
typedef XrResult (XRAPI_PTR *PFN_xrReset3DofAlpha)(const float* pose);
typedef XrResult (XRAPI_PTR *PFN_xrNotifyHeadTrackerRecenter)(void);
typedef XrResult (XRAPI_PTR *PFN_xrSetVehicleMode)(int32_t on);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetOriPhonePose(
    float*                                      out);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetHistoryPose(
    uint64_t                                    timeStamp,
    float*                                      position,
    float*                                      orientation);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetFrustumInfo(
    float*                                      frustum_left,
    float*                                      frustum_right);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetCurrentFrameTimeStamp(
    uint64_t*                                   timeStamp);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassName(
    char*                                       glass_name,
    int32_t                                     outSize);

XRAPI_ATTR XrResult XRAPI_CALL xrIsUsbConnect(
    XrBool32*                                   isUsbConnect);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassProductId(
    int32_t*                                    product_id);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassTypeId(
    char*                                       glass_typeid,
    int32_t                                     outSize);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassSeed(
    char*                                       glass_seed,
    int32_t                                     outSize);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassSn(
    char*                                       glass_sn,
    int32_t                                     outSize);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassFirmwareVersion(
...
XRAPI_ATTR XrResult XRAPI_CALL xrRKOpenMarker(
    const void* XR_MAY_ALIAS                    database,
    uint32_t                                    size);

XRAPI_ATTR XrResult XRAPI_CALL xrRKCloseMarker(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrRKMarkerAcquireChanges(
    XrRokidMarkerArrayExt*                      added,
    XrRokidMarkerArrayExt*                      updated,
    XrRokidMarkerIdArrayExt*                    removed,
    intptr_t*                                   handle);

XRAPI_ATTR XrResult XRAPI_CALL xrRKMarkerReleaseChanges(
    intptr_t                                    handle);

XRAPI_ATTR XrResult XRAPI_CALL xrRKMarkerAddImagePhy(
    const char*                                 name,
    int32_t                                     id,
...
XRAPI_ATTR XrResult XRAPI_CALL xrRKOpenMarker2(
    const void* XR_MAY_ALIAS                    database,
    uint32_t                                    size);

XRAPI_ATTR XrResult XRAPI_CALL xrRKCloseMarker2(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrRKMarker2AddImagePhy(
    const char*                                 id,
    const uint8_t*                              imageData,
    int32_t                                     width,
    int32_t                                     height,
...
XRAPI_ATTR XrResult XRAPI_CALL xrRKMarker2AcquireChanges(
    XrRokidMarker2ArrayExt*                     added,
    XrRokidMarker2ArrayExt*                     updated,
    XrRokidMarker2ArrayExt*                     removed);

XRAPI_ATTR XrResult XRAPI_CALL xrRKMarker2GetCenterPose(
    intptr_t                                    marker,
    float*                                      out);

XRAPI_ATTR XrResult XRAPI_CALL xrRKMarker2GetExtent(
    intptr_t                                    marker,
    float*                                      outX,
    float*                                      outZ);

XRAPI_ATTR XrResult XRAPI_CALL xrRKMarker2GetId(
    intptr_t                                    marker,
    char*                                       id,
    int                                         idSize);

XRAPI_ATTR XrResult XRAPI_CALL xrRKMarker2GetAlgoId(
    intptr_t                                    marker,
    intptr_t*                                   id);

XRAPI_ATTR XrResult XRAPI_CALL xrRKOpenAnchor(
    const void* XR_MAY_ALIAS                    arg,
    uint32_t                                    size);

XRAPI_ATTR XrResult XRAPI_CALL xrRKCloseAnchor(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrRKAnchorAcquireChanges(
    XrRokidAnchorArrayExt*                      added,
    XrRokidAnchorArrayExt*                      updated,
    XrRokidAnchorIdArrayExt*                    removed,
    int32_t*                                    err,
    intptr_t*                                   handle);

XRAPI_ATTR XrResult XRAPI_CALL xrRKAnchorReleaseChanges(
    intptr_t                                    handle);

XRAPI_ATTR XrResult XRAPI_CALL xrRKAnchorTryAdd(
    const float*                                pose,
    XrRokidAnchorExt*                           out);

XRAPI_ATTR XrResult XRAPI_CALL xrRKAnchorTryRemove(
    intptr_t                                    id);

XRAPI_ATTR XrResult XRAPI_CALL xrRKAnchorSave(
    intptr_t                                    id);

XRAPI_ATTR XrResult XRAPI_CALL xrRKMapGetAll(
    XrRokidAnchorMapArrayExt*                   out);

XRAPI_ATTR XrResult XRAPI_CALL xrRKMapRemove(
    const XrRokidAnchorMapExt*                  map);

XRAPI_ATTR XrResult XRAPI_CALL xrRKMapGetAnchors(
    const XrRokidAnchorMapExt*                  map,
    XrRokidAnchorIdArrayExt*                    out);

XRAPI_ATTR XrResult XRAPI_CALL xrOpenGestureTracker(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrCloseGestureTracker(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrGetTrackingHandNum(
    uint32_t*                                   number);

XRAPI_ATTR XrResult XRAPI_CALL xrGetTrackingHandLrHand(
    uint32_t                                    index,
    uint32_t*                                   hand);

XRAPI_ATTR XrResult XRAPI_CALL xrGetTrackingHandCombineGestureType(
    uint32_t                                    index,
    uint32_t*                                   type);

XRAPI_ATTR XrResult XRAPI_CALL xrGetTrackingHandOrientation(
    uint32_t                                    index,
    uint32_t*                                   orientation);

XRAPI_ATTR XrResult XRAPI_CALL xrGetUpForwardInfluencePow(
    float*                                      factor);

XRAPI_ATTR XrResult XRAPI_CALL xrGetTrackingHandPinchDistance(
    uint32_t                                    index,
    float*                                      distance);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGestureSkeletonPosition(
    float*                                      data,
    uint32_t                                    index,
    uint32_t                                    mode);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGestureSkeletonRotation(
    float*                                      data,
    uint32_t                                    index,
    uint32_t                                    mode,
    uint32_t                                    type);

XRAPI_ATTR XrResult XRAPI_CALL xrRecenterHeadTrackerY(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrSetTrackingType(
    int32_t                                     type);

XRAPI_ATTR XrResult XRAPI_CALL xrSetGlassPSensorListener(
    PFN_xrGlassPSensorListener                  listener);

XRAPI_ATTR XrResult XRAPI_CALL xrClearGlassPSensorListener(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrSetPropertiesValue(
    char*                                       key,
    char*                                       value);

XRAPI_ATTR XrResult XRAPI_CALL xrGetPropertiesValue(
    char*                                       key,
    char*                                       value);

XRAPI_ATTR XrResult XRAPI_CALL xrResetSlam(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrVibrate(
    int32_t                                     effectId);

XRAPI_ATTR XrResult XRAPI_CALL xrGetMainScreenWidth(
    int32_t*                                    width);

XRAPI_ATTR XrResult XRAPI_CALL xrGetMainScreenHeight(
    int32_t*                                    height);

XRAPI_ATTR XrResult XRAPI_CALL xrGetDebugInfo(
    char*                                       debugInfo,
    int32_t                                     size);

XRAPI_ATTR XrResult XRAPI_CALL xrConfigSlam(
    int32_t                                     type,
    int32_t                                     value);

XRAPI_ATTR XrResult XRAPI_CALL xrGetCameraYPR(
    float*                                      ypr);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassScreenWidth(
    int32_t*                                    width);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassScreenHeight(
    int32_t*                                    height);

XRAPI_ATTR XrResult XRAPI_CALL xrSetGlassStatusListener(
    PFN_xrGlassStatusListener                   listener);

XRAPI_ATTR XrResult XRAPI_CALL xrSetGestureLogLevel(
    const char*                                 lv);

XRAPI_ATTR XrResult XRAPI_CALL xrStartCameraPreview(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrStopCameraPreview(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrGetCameraStatus(
    int32_t*                                    flag);

XRAPI_ATTR XrResult XRAPI_CALL xrGetCameraPreviewDimension(
    uint16_t*                                   width,
    uint16_t*                                   height);

XRAPI_ATTR XrResult XRAPI_CALL xrSetCameraPreviewListener(
    PFN_xrCameraPreviewListener                 listener);

XRAPI_ATTR XrResult XRAPI_CALL xrNotifyHandTrackerRecenter(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrSetGlassIMUListener(
    PFN_xrSensorListener                        sensorListenerP,
    PFN_xrRotationListener                      rotationListenerP);

XRAPI_ATTR XrResult XRAPI_CALL xrClearGlassIMUListener(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrOpenHeadTracker(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrCloseHeadTracker(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrOpenPhoneTracker(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrClosePhoneTracker(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrSetGlassBrightListener(
    PFN_xrGlassBrightListener                   listener);

XRAPI_ATTR XrResult XRAPI_CALL xrClearGlassBrightListener(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassBrightness(
    int32_t*                                    value);

XRAPI_ATTR XrResult XRAPI_CALL xrSetGlassBrightness(
    int32_t                                     value);

XRAPI_ATTR XrResult XRAPI_CALL xrGetGlassCalFile(
    uint8_t*                                    value,
    uint32_t                                    bufSize);

XRAPI_ATTR XrResult XRAPI_CALL xrSetGestureUseDSP(
    int32_t                                     value);

XRAPI_ATTR XrResult XRAPI_CALL xrSetGestureUseFishEyeDistort(
    int32_t                                     value);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSkeletonRotationAll(
    float*                                      data,
    int32_t                                     index,
    int32_t                                     type);

XRAPI_ATTR XrResult XRAPI_CALL xrGetSkeletonCAM_GLAxis(
    float*                                      data,
    int32_t                                     index);

XRAPI_ATTR XrResult XRAPI_CALL xrGetHeadPoseRHS(
    float*                                      position,
    float*                                      orientation,
    int64_t*                                    timestamp);

XRAPI_ATTR XrResult XRAPI_CALL xrGetMagnCalibSteps(
    uint32_t*                                   steps);

XRAPI_ATTR XrResult XRAPI_CALL xrStartMagnCalib(
    uint32_t                                    step);

XRAPI_ATTR XrResult XRAPI_CALL xrStopMagnCalib(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrResetMagnCalib(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrGetMagnCalibStatus(
    uint32_t                                    step,
    int32_t*                                    status);

XRAPI_ATTR XrResult XRAPI_CALL xrResetHead3DofCenter(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrGetDistortionQuad(
    float*                                      quad_left,
    float*                                      quad_right);

XRAPI_ATTR XrResult XRAPI_CALL xrHeadTrackingFix(
    int32_t                                     ypr);

XRAPI_ATTR XrResult XRAPI_CALL xrSet3DofAlpha(
    float                                       alpha);

XRAPI_ATTR XrResult XRAPI_CALL xrReset3DofAlpha(
    const float*                                pose);

XRAPI_ATTR XrResult XRAPI_CALL xrNotifyHeadTrackerRecenter(
    void                                        );

XRAPI_ATTR XrResult XRAPI_CALL xrSetVehicleMode(
    int32_t                                     on);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
