...
/// Calls your macro with the name of each member of XrRokidMarkerExt, in order.
#define XR_LIST_STRUCT_XrRokidMarkerExt(_) \
    _(name) \
    _(pose) \
    _(size) \
    _(imageIndex) \
...
/// Calls your macro with the name of each member of XrRokidMarkerArrayExt, in order.
#define XR_LIST_STRUCT_XrRokidMarkerArrayExt(_) \
    _(elements) \
    _(size) \

/// Calls your macro with the name of each member of XrRokidMarkerIdArrayExt, in order.
#define XR_LIST_STRUCT_XrRokidMarkerIdArrayExt(_) \
    _(elements) \
    _(size) \

/// Calls your macro with the name of each member of XrRokidMarker2ArrayExt, in order.
#define XR_LIST_STRUCT_XrRokidMarker2ArrayExt(_) \
    _(elements) \
    _(size) \

/// Calls your macro with the name of each member of XrRokidAnchorExt, in order.
#define XR_LIST_STRUCT_XrRokidAnchorExt(_) \
    _(id) \
    _(pose) \
    _(score) \
    _(flags) \

/// Calls your macro with the name of each member of XrRokidAnchorArrayExt, in order.
#define XR_LIST_STRUCT_XrRokidAnchorArrayExt(_) \
    _(elements) \
    _(size) \

/// Calls your macro with the name of each member of XrRokidAnchorIdArrayExt, in order.
#define XR_LIST_STRUCT_XrRokidAnchorIdArrayExt(_) \
    _(elements) \
    _(size) \

/// Calls your macro with the name of each member of XrRokidAnchorMapExt, in order.
#define XR_LIST_STRUCT_XrRokidAnchorMapExt(_) \
    _(uuid) \

/// Calls your macro with the name of each member of XrRokidAnchorMapArrayExt, in order.
#define XR_LIST_STRUCT_XrRokidAnchorMapArrayExt(_) \
    _(elements) \
    _(size) \
