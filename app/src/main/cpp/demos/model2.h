...
#include "cadDataManager/include/manager/dimensionManager.h"
...
public:
    ...
    const std::map<std::string, Mesh> &getMMeshes() const {
        return mMeshes;
    }
...
private:
    ...
    Mesh createMeshFromCustomData(const std::vector<glm::vec3> &positions,
